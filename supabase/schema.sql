...
alter table activities drop constraint if exists activities_latitude_check;
alter table activities add constraint activities_latitude_check check (latitude is null or latitude between -90 and 90);
alter table activities drop constraint if exists activities_longitude_check;
alter table activities add constraint activities_longitude_check check (longitude is null or longitude between -180 and 180);
